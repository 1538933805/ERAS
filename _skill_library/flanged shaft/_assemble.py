...
#@markdown
"设置被抓取的位姿"
pos_c = [246.0e-3, -612e-3, 56.5e-3, 0, -3.1415926, -1.5707963]
# env.rob.moveIK(pos_c[0:3], pos_c[3:6], wait=True)
pos_c_up = pos_c.copy()
pos_c_up[2] += 100e-3
"设置被装配的位姿"
pos_a = [-6.96e-3, -649.11e-3, 107.71e-3, 0, -3.1415, 0]
...
env.rob.closeRG2()
#往下抵住
env.rob.moveIK_changePosOrt(d_pos=[0e-3,0e-3,-2e-3], d_ort=[0,0,0], wait=True)
# time.sleep(2)
# 被抓取位置上方
